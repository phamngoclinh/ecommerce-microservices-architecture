...
export class AddAuditColumns1762586560223 implements MigrationInterface {
    name = 'AddAuditColumns1762586560223'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TABLE "temporary_payment_methods" (
        ...
        `);
        await queryRunner.query(`
            INSERT INTO "temporary_payment_methods"(
                    "id",
                    "created_at",
                    "updated_at",
                    "provider",
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "temporary_payment_methods"
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "payment_methods"
                RENAME TO "temporary_payment_methods"
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            SELECT "id",
                ...
                "created_by",
                "updated_by"
            FROM "temporary_payment_methods"
        `);
        await queryRunner.query(`
            DROP TABLE "temporary_payment_methods"
        `);
        await queryRunner.query(`
            ALTER TABLE "refunds"
